...
<section>
    <div class="rounded-lg bg-dark m-4 py-8">
        <div class="text-white text-center py-8 md:py-12 lg:py-24">
            ...
            <a class="inline-flex items-center px-8 py-2 border border-transparent font-bold rounded-full text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" href="{{ route(RoutesEnum::ADMIN_INDEX_CLIENTS, $locale) }}">
                To admin panel
            </a>
        </div>
