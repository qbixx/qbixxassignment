    ...
    <AdminLayout>
        ...
        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <div class="py-8 px-6 flex justify-end">
                <a class="inline-block px-6 py-2 border-2 border-blue-600 bg-blue-600 border-blue-600 text-white leading-tight font-bold rounded hover:bg-blue-500 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
            ...
            <div class="overflow-hidden">
                <table class="min-w-full">
                    ...
                    <tr v-for="client in clients"
                        ...
                        <td class="w-auto text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{
                                client.name
                            }}
                        </td>
                        <td class="w-4/12 text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <div class="flex space-x-2 justify-end">
                                <a class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 py-0 px-1"
                                   :href="'/admin/clients/'+client.id" title="View on front-end">
                                ...
                                <a class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 py-0 px-1"
                                   :href="'/admin/clients/'+client.id+'/edit'" title="Edit">
        ...
        deleteClient(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let result = await axios.post("/api/clients/" + id + "/delete")
